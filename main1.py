...
person = db_persons.search_by_id('a84c50cb-a56f-4aec-86aa-63c7fd7beaf7')
print(person)
list_fines: list = person.list_fine.get_list_fines()
print(list_fines[0])
update_fine = Fine('New fine', 200, 'Kyiv')
db_persons.update(person.code_id, 'new Name')
db_persons.update(person.code_id, fine=list_fines[0], new_fine=update_fine)
